...
function generateTableRow() {
	...
	emptyColumn.innerHTML = '<td style=""><a style="color: #FFF;" class="cut btn btn-primary">-</a><a style="color: #FFF;" class="tr_clone_add1 btn btn-primary">+</a><input style="border-color: #126aef;" contenteditable class="form-control service1" list="service1" autocomplete="off"></td>'+
							...
							'<td class="colonneassurance"  style="display:none;"><input style="border-color: #126aef;text-align: center;" class="form-control pourcent" type="number"></td>'+
                            '<td class="colonneassurance"  style="display:none;"><input style="border-color: #126aef;text-align: right;" class="form-control plafond" type="number"></td>'+
							'<td style="text-align: right"><span>0</span><span data-prefix> FCFA</span></td>'+
							'<td style="" ><input style="border-color: #126aef;text-align: center" contenteditable class="form-control qte1" type="number" value="0"></td>'+
							'<td style="text-align: right;"><span>0</span><span data-prefix> FCFA</span></td>';
 ...
 function generateTableRow2() {
	...
	emptyColumn.innerHTML = '<td style=""><a style="color: #FFF;" class="cut btn btn-primary">-</a><a style="color: #FFF;" class="tr_clone_add2 btn btn-primary">+</a><input style="border-color: #126aef;" contenteditable class="form-control service2" list="service2" autocomplete="off"></td>'+
							'<td style="text-align: center;"><span></span></td>'+
							'<td class="colonneassurance"  style="display:none;"><input style="border-color: #126aef;text-align: center;" class="form-control pourcent" type="number"></td>'+
                            '<td class="colonneassurance"  style="display:none;"><input style="border-color: #126aef;text-align: right;" class="form-control plafond" type="number"></td>'+
							'<td style="text-align: right"><span>0</span><span data-prefix> FCFA</span></td>'+
							'<td style="" ><input style="border-color: #126aef;text-align: center" contenteditable class="form-control qte2" type="number" value="0"></td>'+
							'<td style="text-align: right;"><span>0</span><span data-prefix> FCFA</span></td>';
	return emptyColumn;
 }
 ...
 function generateTableRow3() {
	...
	emptyColumn.innerHTML = '<td style=""><a style="color: #FFF;" class="cut btn btn-primary">-</a><a style="color: #FFF;" class="tr_clone_add3 btn btn-primary">+</a><input style="border-color: #126aef;" contenteditable class="form-control service3" list="service3" autocomplete="off"></td>'+
							'<td style="text-align: center;"><span></span></td>'+
							'<td class="colonneassurance"  style="display:none;"><input style="border-color: #126aef;text-align: center;" class="form-control pourcent" type="number"></td>'+
                            '<td class="colonneassurance"  style="display:none;"><input style="border-color: #126aef;text-align: right;" class="form-control plafond" type="number"></td>'+
							'<td style="text-align: right"><span>0</span><span data-prefix> FCFA</span></td>'+
							'<td style="" ><input style="border-color: #126aef;text-align: center" contenteditable class="form-control qte3 valinc" type="number" value="0"></td>'+
 ...
 function generateTableRow4() {
	...
	emptyColumn.innerHTML = '<td style=""><a style="color: #FFF;" class="cut btn btn-primary">-</a><a style="color: #FFF;" class="tr_clone_add4 btn btn-primary">+</a><input style="border-color: #126aef;" contenteditable class="form-control service4" list="service4" autocomplete="off"></td>'+
							'<td style="text-align: center;"><span></span></td>'+
							'<td class="colonneassurance"  style="display:none;"><input style="border-color: #126aef;text-align: center;" class="form-control pourcent valinc2" type="number"></td>'+
                            '<td class="colonneassurance"  style="display:none;"><input style="border-color: #126aef;text-align: right;" class="form-control plafond valinc" type="number"></td>'+
							'<td style="text-align: right"><span>0</span><span data-prefix> FCFA</span></td>'+
							'<td style="" ><input style="border-color: #126aef;text-align: center" contenteditable class="form-control qte4 valinc" type="number" value="0"></td>'+
							'<td style="text-align: right;"><span>0</span><span data-prefix> FCFA</span></td>';
	...
	$.ajax({  
		...
		success: function (result) {  
			if (result.nom_article!=null) {
				$(CellTarget).prop('readonly', true);
				$(CellTarget).closest('td').next('td').find('span').text("");
...
function updateInvoice() {
	...
	var taxeir = parseInt(document.getElementById("taxe").value);
	var remise = 0;
	...
	$('#total_ttc').text(SeparateurDeMillier(parseInt(montant_patient+montant_assur+parseInt(montant_assur)*taxeir*0.01).toString()));
	...
	$('#montant_lettre').text(NumberToLetter(parseInt(montant_patient+montant_assur)+parseInt(montant_assur)*taxeir*0.01)+" FCFA");
	$('#esp').text(SeparateurDeMillier((parseInt(montant_patient-remise)).toString()));
	$('.tot').text(SeparateurDeMillier(parseInt(montant_patient+montant_assur+montant_assur*taxeir*0.01).toString()));
	$('.total_ass').text(SeparateurDeMillier((parseInt(montant_assur)+parseInt(montant_assur)*taxeir*0.01).toString()));
	$('#totalassurance').val(parseInt(montant_assur)+parseInt(montant_assur)*taxeir*0.01);
	$('.total_assht').text(SeparateurDeMillier((parseInt(montant_assur)).toString()));
	$('#montant_lettre_assurance').val(NumberToLetter(parseInt(montant_assur)+parseInt(montant_assur)*taxeir*0.01)+" FCFA");
...
$(document).on('click', '#saveFacture', function(e) {
	updateInvoice();
			...
			if (facture.Medecin=="" || facture.Medecin==null || (facture.Assureur=="" && $("#target").val().includes("assurance")) || isNaN(facture.Total_ht) || isNaN(facture.Net_a_payer_patient)) {
				$("#valinc").show();
			}else{
				$.ajax({
					type: "POST",
					...
					success: function (result) {
						if (result=="erreur: valeurs incorrectes") {
							...
							if ($("#target").val().includes("medicament")) {
								...
								location.href = "/Facture/Details/"+result;
							}else{
