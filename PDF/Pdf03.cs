...
namespace BANA.PDF
{
    public class PdfGeneration03
    {
        private readonly ExamenContext _context;

        public PdfGeneration03(ExamenContext context)
        {
            _context = context;
        }
        ...
        public async Task<MemoryStream> DetailsExamen(int id)
        {
            ...
            var examen = await _context.Examen
                ...
                if (examen.Contenu==null){ examen.Contenu = ""; }else if(examen.Nom.ToLower().Contains("nfs")){ examen.Contenu = examen.Contenu.Replace("#126aef", "#ffffff"); }
            ...
            using (MemoryStream memoryStream = new MemoryStream())
            {
                ...
                var elements = HtmlConverter.ConvertToElements(examen.Contenu, props);
